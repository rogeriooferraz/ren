...
It is a lightweight, safe, and portable Bash script for renaming files in bulk using **wildcard patterns** or **regular expressions**.

Inspired by `mmv`-style syntax, it supports dry-run previews, pattern groups, and conflict detection.
